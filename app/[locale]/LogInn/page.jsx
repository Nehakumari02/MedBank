...
//         <p>{t.rich('SignIn.acknowledgement', {
//           terms: (chunks) => <a href="/terms-and-conditions">{chunks}</a>,
//           personalInfo: (chunks) => <a href="/personal-information">{chunks}</a>,
//           cancellationPolicy: (chunks) => <a href="/cancellation-policy">{chunks}</a>,
//           sitePolicy: (chunks) => <a href="/site-policy">{chunks}</a>,
//           privacyPolicy: (chunks) => <a href="/privacy-policy">{chunks}</a>
//         })}</p>
            ...
            <div className='w-full flex flex-col gap-[12px]'>
              <div className='w-full flex flex-col gap-[20px]'>
                <div className="group w-full h-[38px] md:h-[50px] flex items-center justify-center flex-col">
                  <div className={`w-full rounded-[7px] ${emailError ? "bg-red-600" : "bg-gray-200"} group-focus-within:${emailError?"bg-red-600":"gradient-primary"}`} >
                ...
                <div className="group w-full h-[38px] md:h-[50px] flex items-center justify-center flex-col">
                  <div className={`w-full relative rounded-[7px] ${emailError ? "bg-red-600" : "bg-gray-200"} group-focus-within:${emailError?"bg-red-600":"gradient-primary"}`} >
                    <input className="w-full p-[10px] md:p-[12px] outline-none rounded-[6px] border-[2px] border-transparent font-DM-Sans font-normal text-[12px] md:text-[16px] leading-[16px] md:leading-[24px]"
