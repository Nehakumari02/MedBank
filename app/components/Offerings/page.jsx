...
const Offerings = () => (
    ...
    <div className='w-[70%] h-full flex items-center justify-start text-[#333333]'>
      <div className='h-[428px] w-full pl-[62px] pr-[20px] flex flex-col gap-[32px]'>
        <HomePageSectionHeader title={"Our services"}></HomePageSectionHeader>
        <div className='pl-[110px] flex flex-col items-start justify-start gap-[24px]'>
        <span className="flex items-start justify-start gap-[12px] font-sans text-[36px] font-medium leading-[42px] text-[#60B7CF]">OFFERINGS {ArrowRightIcon}</span>
