...
const PriceTable = () => (
  <>
    <section className="px-[62px] py-[100px] w-full text-[#333333]">
        <HomePageSectionHeader title={"Reference Price"}/>
        <div className='pl-[90px] pt-[20px] w-full flex flex-col items-start gap-[32px]'>
        <span className="flex items-start justify-start gap-[12px] font-sans text-[36px] font-medium leading-[42px] text-[#60B7CF]">PRICE TABLE {ArrowRightIcon}</span>
        ...
        <thead className="">
          <tr className="bg-[#4DBED8] rounded-tl-[10px] rounded-tr-[10px] h-[80px] flex items-center justify-between px-[20px]">
            <th className="">Read Length</th>
            <th className="">Plan</th>
            <th className="">Data Volume</th>
            <th className="">Reference Price</th>
            <th className="">Delivery Time</th>
          </tr>
        </thead>
        <tbody className="w-full">
          <tr>
            <td className="">DNA Sequencing</td>
            <td className=""></td>
            <td className=""></td>
            <td className=""></td>
            <td className=""></td>
          ...
          <tr>
            <td className="">RNA Sequencing</td>
            <td className=""></td>
            <td className=""></td>
            <td className=""></td>
            <td className=""></td>
          ...
          <tr>
            <td className="">Amplicon Sequencing</td>
            <td className=""></td>
            <td className=""></td>
            <td className=""></td>
            <td className=""></td>
          ...
          <tr>
            <td className="">Human Genome Sequencing</td>
            <td className=""></td>
            <td className=""></td>
            <td className=""></td>
            <td className=""></td>
