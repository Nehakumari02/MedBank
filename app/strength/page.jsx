    ...
    <>
      <section className="w-full flex flex-col items-center justify-center text-[#333333] gap-12 px-4 lg:px-0">
        <div className="w-full lg:w-[1057px] py-10 lg:py-20 flex flex-col items-start gap-6 lg:gap-8">
          <h2 className="w-full lg:w-[110px] leading-6 font-sans text-lg lg:text-[18px] font-medium">Our Strength</h2>
          <div className="w-full lg:w-[864px] text-2xl lg:text-4xl font-bold leading-8 lg:leading-10">
            Comprehensive Next Generation Sequencing Processes
          </div>
          <div className="font-sans font-normal text-lg lg:text-xl">
          ...
          <span className='font-sans font-medium text-xl lg:text-2xl'>
            Benefits
          </span>
          <div>
            <ol className='font-sans font-normal text-lg lg:text-xl leading-8'>
