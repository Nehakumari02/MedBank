...
const page = () => {
  return (
    <>
      <section className='max-w-screen-lg mx-auto text-[#333333] font-DM-Sans flex flex-col items-center justify-center pt-[60px] px-4'>

        <div className='w-full flex flex-col items-start gap-[39px]'>
          <div className='text-[14px] sm:text-[18px]'>Our Services</div>
      ...
      <div className="px-[10px] md:px-[42px] lg:px-[62px] pt-[100px] w-full text-[#333333]">
        <table className="w-full">
          <thead className="">
            <tr className="gradient-table-head rounded-tl-[10px] rounded-tr-[10px] h-[80px] text-[10px] px-[20px] sm:text-[20px] md:-[24px] flex items-center justify-between  ">
