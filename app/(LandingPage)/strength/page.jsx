...
export default function StrengthPage() {
  return (
    <>
      <section className="w-full flex flex-col items-center justify-center text-[#333333] gap-[24px] sm:gap-[70px] md:gap-[100px] px-4 lg:px-0 pt-[20px] sm:pt-[60px] ">
        <div className="w-full lg:w-[1057px] flex flex-col items-start gap-[6px] sm:gap-[10px] md:gap-[24px]">
          ...
          <div>
            <ol className='font-DM-Sans font-normal text-[12px] sm:text-[18px] md:text-[24px] leading-8'>
