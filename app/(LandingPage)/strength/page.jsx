    ...
    <>
      <section className="w-full flex flex-col items-center justify-center text-[#333333] gap-12 px-4 lg:px-0">
        <div className="w-full lg:w-[1057px] py-10 lg:py-20 flex flex-col items-start gap-6 lg:gap-8">
          <h2 className="w-full lg:w-[110px] leading-6 font-sans text-[14px] sm:text-[18px] font-medium">Our Strength</h2>
          ...
          <div className="font-sans font-normal text-[12px] sm:text-[18px] md:text-[24px]">
          ...
          <span className='font-sans font-medium text-[16px] sm:text-[28px]'>
            Benefits
          </span>
          <div>
            <ol className='font-sans font-normal text-[12px] sm:text-[18px] md:text-[24px] leading-8'>
