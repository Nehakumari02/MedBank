        ...
        <>
            <section className=" w-[100vw]  flex flex-col items-center justify-center text-[#333333]">
                <div className="w-[1032px]  py-[60px]  flex flex-col items-start gap-[24px]">
                    <h2 className="w-[161px] leading-[24px] font-sans text-[32px] font-bold">Site Policy</h2>
                    <span className='font-normal font-sans text-[24px] leading-36px'>Customers using the website (https://medbank.sg/) provided by Medbank (hereinafter
                        referred to as “we” or “us”) are requested to fully read the following.</span>
                    <div>
                        ...
                        <span className='font-normal font-sans text-[24px] leading-36px'>
                            Although we takes the utmost care in posting information on the Medbank's website,
                            Medbank does not guarantee the accuracy or completeness of this information. <br></br>
                            ...
                            a result of your use of the information or content contained in the Medbank Web site.
                        </span>
                    </div>
                    <div>
                        ...
                        <span className='font-normal font-sans text-[24px] leading-36px'>
                            ...
                            website are the copyrighted property of the Medbank or third parties. <br></br>
                            ...
                            prior permission of the copyright holder. You may not use (including reproduction,
                            modification, distribution, public transmission, etc.) this information without the prior
                            permission of the copyright holder. <br></br>
                    ...
                    <div>
                        ...
                        <span className='font-normal font-sans text-[24px] leading-36px'>
                            ...
                            Unless otherwise provided herein, the use of this Web site shall be governed by and
                            construed in accordance with the laws of Japan. <br></br>
                            Access to Medbank website is at the discretion of the user, and the user assumes all
                            responsibility for the use of Medbank website. <br></br>
                            Unless otherwise specified, the Hiroshima District Court shall be the court of first jurisdiction
                            for all disputes related to the use of this website. <br></br>
                        </span>
                    </div>
                    <span className='font-normal font-sans text-[24px] leading-36px'>
                        ...
                        under any of the following. <br></br>
                        Websites that include content that defames or slanders Medbank, other companies (or
                        persons), or other organizations, or that is intended to discredit them. <br></br>
                    ...
                    <span className='font-normal font-sans text-[24px] leading-36px'>
                        ...
                        website or a new browser window opens to display our website).
                        ...
                        operation of Medbank website services. <br></br>
                        ...
                        way as to misidentify the source of the information. <br></br>
                        Please note that the URL of Medbank website is subject to change without notice. <br></br>
                        【Others】 <br></br>
                        Please note that Medbank shall not be liable for any compensation, complaints, etc. related
                        to the link. <br></br>
                        ・Prohibited Matters <br></br>
                        The following actions are prohibited when using this website. <br></br>
                        ・Actions that cause or may cause annoyance, disadvantage, or damage to other users, third
                        parties, or Medbank. <br></br>
                        ・Actions that infringe or may infringe on the property or privacy of other users, third parties,
                        or Medbank. <br></br>
                        ・Actions that are or may be offensive to public order and morals. <br></br>
                        ・Actions that violate or may violate laws, regulations, or ordinances. <br></br>
                        ・Any other actions that the Company deems inappropriate. <br></br>
                    </span>
                </div>
