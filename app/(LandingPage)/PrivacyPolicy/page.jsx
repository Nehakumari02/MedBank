            ...
            <div className='max-w-[1056px] w-full flex flex-col items-start'>
                ...
                <div className='text-[#333333] pt-[24px] md:pt-[40px]'>
                    ...
                    <div className='max-w-full font-sans font-normal text-[12px] md:text-[24px] leading-[34px] pl-[60px]'>
                        ...
                        2. Forms of Documents to be Submitted upon Request for Disclosure <br />
                        ...
                        3. Method of confirming that the person making the request for disclosure is the principal or agent The identity of the person making the request for disclosure will be confirmed by one of the following methods <br />
                        (1) The applicant must send us by mail or bring and present a document that proves that he/she is the person in question. <br />
                        (2) We will verify your personal information (telephone number, etc.) that we have in our possession by comparing it with the personal information that we confirmed when we received your inquiry. If a representative is applying on your behalf, please submit a document evidencing your authority of representation. <br /><br />

                        4. Method of collecting fees <br />
                        A fee of 11,000 yen including tax will be collected per request for disclosure of personal information.
                    </div>
                </div>
            </div>
        </section>
