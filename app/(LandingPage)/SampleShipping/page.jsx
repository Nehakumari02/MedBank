...
const page = () => {
    return (
        <section className='w-full flex flex-col justify-center items-center'>
            <div className='w-full max-w-[1056px] flex flex-col items-start'>
                <div className='text-[#333333] pt-[60px] px-4 md:px-6 lg:px-8'>
                    <div className='w-50px font-DM-Sans font-medium text-[14px] sm:text-[18px] leading-[24px] pb-[14px]'>
                        step 1
                    </div>
                    <div className='font-DM-Sans font-bold text-[16px] sm:text-[28px] md:text-[32px] leading-[24px]'>
                        Sample Preparation
                    </div>
                </div>
                <div className='text-[#333333] pt-[40px] px-4 md:px-6 lg:px-8'>
                    ...
                    <div className='w-full font-DM-Sans font-normal text-[12px] sm:text-[18px] lg:text-[24px] leading-[34px]'>
                ...
                <div className='text-[#333333] pt-[40px] px-4 md:px-6 lg:px-8'>
                    <div className='flex flex-col pb-[40px] md:pb-[6px] text-[18px] sm:text-[28px] '>
                ...
                <div className='w-full px-4 md:px-6 lg:px-8'>
                    <div className='pt-[40px]'>
                        ...
                        <div className='font-DM-Sans font-normal text-[12px] sm:text-[24px]  leading-[34px] pt-[30px]'>
