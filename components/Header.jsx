...
const Header = () => {
  ...
  <header className="h-[60px] md:h-[146px] bg-white shadow-md p-[32px] flex justify-between items-center gap-[10px] border-b-[0.5px]">
    ...
    <div className='font-DM-Sans relative flex items-center justify-center gap-[16px] text-[14px] lg:text-[18px] tracking-tracking-0.5'>
      ...
      <button className="hidden h-[40px] w-[108px] p-[1px] rounded-[6px] md:flex items-center justify-center gradient-primary border-[#60B7CF]"><div className='bg-white w-full h-full rounded-[5px] flex items-center justify-center'><span className='gradient-primary bg-clip-text text-transparent'>Sign In</span></div></button>
      <button className="hidden h-[40px] w-[117px] rounded-[6px] md:flex items-center justify-center gradient-primary text-white">Sign Up</button>
